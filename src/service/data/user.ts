  ...
  try {
    return new UserData({
      ...
      apData: new UserAPDataData({
        followersURL: v.apData.followersURL,
        followingURL: v.apData.followingURL,
        inboxURL: v.apData.inboxURL,
        outboxURL: v.apData.outboxURL,
        privateKey: v.apData.privateKey,
        publicKey: v.apData.publicKey,
        userAPID: v.apData.userAPID,
        userID: v.id,
      }),
